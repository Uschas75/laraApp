    ...
    <div data-sidebar-container="chat" class="card chat-sidebar-container sidebar-container">
            ...
            <div class="border-right">
                ...
                <div class="contacts-scrollable perfect-scrollbar ps">
                    ...
                    <div class="p-3 d-flex border-bottom align-items-center contact online">
                        ...
                        <h6 class="">William Wills</h6>
                    </div>
                    <div class="p-3 d-flex border-bottom align-items-center contact online">
                        <img src="{{asset('assets/images/faces/4.jpg')}}" alt="" class="avatar-sm rounded-circle mr-3">
                        <h6 class="">Jaqueline Day</h6>
                    </div>
                    <div class="p-3 d-flex border-bottom align-items-center contact">
                        <img src="{{asset('assets/images/faces/5.jpg')}}" alt="" class="avatar-sm rounded-circle mr-3">
        ...
        <div data-sidebar-content="chat" class="chat-content-wrap sidebar-content" style="margin-left: 260px;">
            ...
            <div class="chat-content perfect-scrollbar ps ps--active-y" data-suppress-scroll-x="true">
                ...
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 360px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 291px;"></div></div></div>
